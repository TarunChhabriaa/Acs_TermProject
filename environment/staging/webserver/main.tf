...
module "globalvars" {
  source = "/home/ec2-user/environment/tpgrp17/modules/globalvars"
}
...
data "terraform_remote_state" "network" {
  backend = "s3"
  config = {
    bucket = "${var.env}-group17-project"
...
module "sg-staging" {
  source       = "/home/ec2-user/environment/tpgrp17/modules/sg_group"
  prefix       = module.globalvars.prefix
...
module "alb-staging" {
  source       = "/home/ec2-user/environment/tpgrp17/modules/load_balancer"
  prefix       = module.globalvars.prefix
  default_tags = module.globalvars.default_tags
  env          = var.env
...
module "launch-config-staging" {
  source        = "/home/ec2-user/environment/tpgrp17/modules/launch_config"
  prefix        = module.globalvars.prefix
  env           = var.env
  sg_id         = module.sg-staging.lb_sg_id
  instance_type = var.instance_type
...
# Auto Scaling Group
module "asg-staging" {
  source       = "/home/ec2-user/environment/tpgrp17/modules/autoscalling_group"
  prefix       = module.globalvars.prefix
  env          = var.env
  default_tags = module.globalvars.default_tags
